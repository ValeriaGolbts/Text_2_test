...
КЛЮЧЕВОЕ ТРЕБОВАНИЕ: Точно следуй СТРУКТУРЕ и КАЧЕСТВУ приведенных примеров.

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

ПРИМЕР №1 (Легкий вопрос на определение):

Материал-источник: "Термодинамика - раздел физики, изучающий тепловые явления и их связь с механической работой. Первый закон термодинамики гласит: изменение внутренней энергии равно сумме работы и теплоты."

СОЗДАННЫЙ ВОПРОС:
{{
    "id": 1,
    "difficulty": "easy",
    "question": "Что изучает термодинамика как раздел физики?",
    "options": [
        "Только тепловые явления",
        "Тепловые явления и их связь с механической работой",
        "Только механическую работу",
        "Электрические и магнитные явления"
    ],
    "correct_answer": "Тепловые явления и их связь с механической работой",
    "explanation": "Согласно определению, термодинамика изучает именно тепловые явления в их связи с механической работой."
}}

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

ПРИМЕР №2 (Средний вопрос на применение):

Материал-источник: "Формула кинетической энергии: E_k = mv²/2, где m - масса, v - скорость. При увеличении скорости в 2 раза, энергия увеличивается в 4 раза."

СОЗДАННЫЙ ВОПРОС:
{{
    "id": 2,
    "difficulty": "medium",
    "question": "Если скорость тела увеличилась в 3 раза, как изменится его кинетическая энергия?",
    "options": [
        "Увеличится в 3 раза",
        "Увеличится в 6 раз",
        "Увеличится в 9 раз",
    ...
    "correct_answer": "Увеличится в 9 раз",
    "explanation": "Кинетическая энергия пропорциональна квадрату скорости (E_k ∝ v²), поэтому при увеличении скорости в 3 раза, энергия увеличивается в 3² = 9 раз."
}}

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

ПРИМЕР №3 (Сложный вопрос на анализ):

Материал-источник: "В замкнутой системе полная энергия сохраняется. Однако при наличии трения часть механической энергии переходит во внутреннюю. Полная энергия (механическая + внутренняя) остается постоянной."

СОЗДАННЫЙ ВОПРОС:
{{
    "id": 3,
    "difficulty": "hard",
    "question": "Почему в системе с трением нельзя утверждать, что полная механическая энергия сохраняется, хотя закон сохранения энергии выполняется?",
    "options": [
        "Закон сохранения энергии не работает при трении",
        "Механическая энергия переходит во внутреннюю, но сумма всех видов энергии постоянна",
        "Трение создает новую энергию из ниоткуда",
        "При трении энергия исчезает полностью"
    ],
    "correct_answer": "Механическая энергия переходит во внутреннюю, но сумма всех видов энергии постоянна",
    "explanation": "Трение не уничтожает энергию, а преобразует механическую энергию во внутреннюю (тепло). Полная энергия (механическая + внутренняя) сохраняется."
}}

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

ТВОЙ МАТЕРИАЛ ДЛЯ СОЗДАНИЯ ТЕСТА:
...
ТРЕБОВАНИЯ К ТВОЕМУ ТЕСТУ (строго как в примерах):

1. Точно такая же структура JSON
2. Аналогичное качество вопросов
3. Разные уровни сложности (easy/medium/hard)
4. Правильные ответы не должны быть очевидными
5. Пояснения должны объяснять, ПОЧЕМУ ответ верен

СОЗДАЙ ТЕСТ из {num_questions} вопросов:

{{
    "test_title": "Название по материалу",
