...
СПЕЦИФИКА АУДИОМАТЕРИАЛА: речь может быть менее структурированной, чем текст. Нужно:
- Очистить речь от слов-паразитов ("эээ", "ну", "так сказать")
- Выделить ОСНОВНЫЕ тезисы (то, что лектор ПОВТОРЯЛ или ВЫДЕЛЯЛ ГОЛОСОМ)
- Игнорировать случайные оговорки и отступления

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

<step1_transcript_cleanup>
<thought>
ШАГ 1: Очистка расшифровки от речевого мусора.
Нужно убрать:
- Слова-паразиты (эээ, ммм, ну, вот, так сказать, понимаете, знаете)
- Повторы фраз ("и ещё, и ещё, и ещё...")
- Отступления от темы
- Маркеры неуверенности ("как бы", "наверное", "по-моему")

После очистки должна остаться только СОДЕРЖАТЕЛЬНАЯ информация.
</thought>
...
<action1>
Выполни очистку и запиши КЛЮЧЕВЫЕ ТЕЗИСЫ лекции.
</action1>
</step1_transcript_cleanup>

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

<step2_concept_extraction>
<thought>
ШАГ 2: Выделение основных концепций.
Из очищенного текста нужно выделить:
- Какие понятия лектор ОПРЕДЕЛЯЛ (явно сказал "X - это...")
- Какие формулы или правила ФОРМУЛИРОВАЛ
- Какие примеры ПРИВОДИЛ для иллюстрации
- Какие идеи ПРОТИВОПОСТАВЛЯЛ друг другу
- Что лектор ПОВТОРЯЛ несколько раз (это важно!)
</thought>

<action2>
Составь список ключевых концепций для теста.
</action2>
</step2_concept_extraction>

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

<step3_question_generation>
<thought>
ШАГ 3: Генерация вопросов по концепциям.
Для каждой ключевой концепции:
1. Сформулируй вопрос АКАДЕМИЧЕСКИМ стилем (не как лектор сказал, а как должно быть в учебнике)
2. Придумай 4 варианта ответа
3. Дистракторы сделай на основе типичных ошибок (если лектор о них говорил)
4. Напиши пояснение, ссылаясь на слова лектора
</thought>
...
<step4_audio_specific_check>
<thought>
ШАГ 4: Финальная проверка для аудио.
Убедись, что:
- Вопросы не просят вспомнить "на какой минуте" или "какой пример"
- Все вопросы понятны БЕЗ знания интонации лектора
- Формулировки НОРМАЛИЗОВАНЫ до письменного академического стиля
- Правильные ответы действительно следуют из содержания лекции
</thought>

<action4>
Проверь и исправь вопросы при необходимости.
</action4>
</step4_audio_specific_check>
...
СОЗДАЙ ТЕСТ в формате JSON:

{{
    "test_title": "...",
    "source_type": "audio_lecture",
    "generation_method": "Chain_of_Thought_Audio",
    "questions": [
        {{
            "id": 1,
            "question": "...",
            ...
            "correct_answer": "...",
            "explanation": "...",
            "lecture_reference": "ключевая фраза лектора (очищенная)"
        }}
    ]
}}
"""
