...
"""
        ...
        prompt = f""" Создай тест из {num_questions} вопросов на основе материала.
...
ИНСТРУКЦИЯ TREE-OF-THOUGHT (рассмотри несколько вариантов и выбери лучший):

Для КАЖДОГО вопроса из {num_questions}:

1. Найди в материале 3 разных концепции, которые можно проверить
2. Для каждой концепции придумай вопрос (всего 3 варианта вопроса)
3. Оцени каждый вариант по шкале 1-10:
   - Сложность (нужно ли думать или слишком легко)
   - Релевантность (проверяет ли главное)
   - Качество дистракторов (обманывают ли другие варианты)
4. Выбери вариант с самой высокой оценкой
5. Сформулируй финальный вопрос с 4 вариантами ответа и пояснением

ТРЕБОВАНИЯ:
- 4 варианта ответа на каждый вопрос
- Только 1 правильный
- Вопросы только по материалу
- Разная сложность
