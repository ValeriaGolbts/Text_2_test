...
ОСОБЕННОСТИ АУДИОМАТЕРИАЛА:
- Текст может содержать речевые обороты, паузы, повторы
- Информация может быть изложена менее структурированно, чем в письменном тексте
- Важно выделить КЛЮЧЕВЫЕ мысли из устного изложения

КЛЮЧЕВОЕ ТРЕБОВАНИЕ: ИЗБЕГАЙ перечисленных ниже ОШИБОК.

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

❌❌❌ ЗАПРЕЩЕННЫЕ ПАТТЕРНЫ (ДЛЯ АУДИО-ТЕСТОВ) ❌❌❌

1. ❌ Вопросы про второстепенные детали (оговорки, примеры из речи лектора)
   ПЛОХО: "Какой пример привёл лектор в середине 3-й минуты?"
   ПОЧЕМУ: Проверяет внимание, а не понимание концепций

2. ❌ Вопросы, основанные на нечётких формулировках лектора
   ПЛОХО: "Что лектор имел в виду, когда сказал 'эта штука работает так'?"
   ПОЧЕМУ: Речь может быть неоднозначной, нужны точные формулировки

3. ❌ Дословное копирование из расшифровки (с учётом речевых оборотов)
   ПЛОХО: Вопрос повторяет фразу с "ну...", "так сказать...", "понимаете..."
   ПОЧЕМУ: Нужно нормализовать речь до академического стиля

4. ❌ Вопросы "Все вышеперечисленное верно" (как и в тексте)
5. ❌ Вопросы с двойным отрицанием
6. ❌ Слишком очевидные дистракторы
7. ❌ Вариант "А и Б" или "Б и В"

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

✅✅✅ ХОРОШИЕ ПАТТЕРНЫ ДЛЯ АУДИОМАТЕРИАЛА ✅✅✅

1. ✅ Вопросы на основные концепции, которые лектор ПОВТОРЯЛ или ВЫДЕЛЯЛ голосом
2. ✅ Вопросы на ПОНИМАНИЕ, а не на запоминание слов лектора
3. ✅ Вопросы на применение: "Если бы студент спросил..., что бы ответил лектор?"
4. ✅ Вопросы на сравнение идей, которые лектор ПРОТИВОПОСТАВЛЯЛ
5. ✅ Дистракторы на основе типичных недопониманий (о которых лектор говорил)
6. ✅ Формулы и определения, которые лектор ЧЁТКО СФОРМУЛИРОВАЛ
...
🔍 ПРОВЕРОЧНЫЙ ЧЕК-ЛИСТ ДЛЯ АУДИО-ТЕСТА:

[ ] Вопрос основан на КЛЮЧЕВОЙ концепции, а не на случайной фразе
[ ] Вопрос можно понять без знания контекста речи (паузы, интонации)
[ ] Формулировка вопроса АКАДЕМИЧЕСКАЯ, а не разговорная
[ ] Нет вопросов про "на какой минуте", "какой пример" (проверка внимания)
[ ] Все 4 варианта правдоподобны
[ ] На вопрос НЕЛЬЗЯ ответить без прослушивания лекции
[ ] Правильный ответ лектор явно сформулировал (или это логический вывод)
...
{{
    ...
    "generation_method": "Negative_Prompting_Audio",
    "questions": [
        {{
            "id": 1,
            "question": "...",
            ...
            "correct_answer": "...",
            "explanation": "...",
            "key_concept_from_lecture": "какая ключевая идея проверяется"
        }}
    ]
}}
"""
